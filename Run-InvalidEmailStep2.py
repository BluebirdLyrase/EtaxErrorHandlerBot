...
sqlTextSelect = 'SELECT [ACCOUNTNUM],[DPL_ETAXMAIL]  \n'
...
f = open("output/InvalidEmailStep2/"+dt_stringDir+".txt", "w")
f.write(sqlText)
f.close()
print('sql text has been create')
print(sqlText)

f = open("output/InvalidEmailStep2/Select"+dt_stringDir+".txt", "w")
